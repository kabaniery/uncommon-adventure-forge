...
import com.kabaniery.uncommonadventure.datagenerators.*;
...
public class MDataGenerator {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        MBlockTagGenerator blockTagGenerator = generator.addProvider(event.includeServer(),
                new MBlockTagGenerator(output, lookupProvider, existingFileHelper));
    }
}
